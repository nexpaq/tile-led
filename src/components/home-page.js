...
class HomePage extends connect(store)(PageViewElement) {
	...
	render() {
		return html`
    <div id="wrapper" class="wrapper" data-color="white" data-controls="simple">
      <div class="page page__selector %hidden">
        <h1 class="page__selector__title">Modes</h1>
        <ul class="modes-list">
          <li class="modes-list-item">
      ...
      <div class="page page__controls hidden">
        <div class="simple-controls hidden">
        ...
        <div class="picker-controls %hidden">
      ...
      <div class="page page__themes hidden">
